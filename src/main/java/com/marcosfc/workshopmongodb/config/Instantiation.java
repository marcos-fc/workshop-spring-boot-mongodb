package com.marcosfc.workshopmongodb.config;
...
import com.marcosfc.workshopmongodb.dto.AuthorDTO;
import com.marcosfc.workshopmongodb.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post2 = new Post(null, sdf.parse("23/003/2022"), "Bom dia", "Acordei feliz hoje!",new AuthorDTO(maria));
